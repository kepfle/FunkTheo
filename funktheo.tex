...
%\includeonly{content/laurent}											% while writing your book, compile only what you need
...
\include{content/folgen}
\include{content/reihen}
\include{content/stetig}
\include{content/raum}
\include{content/kompdiff}
\include{content/holo}
